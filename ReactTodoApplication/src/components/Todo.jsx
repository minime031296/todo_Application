...
const Todo = () => {
    ...
    const handleDelete = (id) => {
        axios({
            ...
            .then(() => getData()) // Added to refresh data after deletion
            .catch((error) => console.log(error));
    };
    ...
    const getData = async () => {
        try {
            ...
            setTodo(response.data); // Updated to set the correct response data
        } catch (error) {
            console.log(error);
        }
    };
    ...
    return (
        <>
            <h1 className="text-center font-bold text-2xl shadow-xs bg-cyan-100 flex justify-center items-center rounded-lg">
                TODO APP
            </h1>
            <div className="mx-auto max-w-4xl p-4">
                ...
                <div className="flex justify-between mt-8">
                    <div className="w-1/2">
                        <h3 className="text-lg font-bold mb-4 items-center text-center">
                            Completed Tasks
                        </h3>
